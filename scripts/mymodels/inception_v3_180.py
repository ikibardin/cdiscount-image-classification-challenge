...
def inception_v3(pretrained, num_classes, input_shape):
    ...
    """
    if pretrained:
        model = Inception3(num_classes=num_classes, input_shape=input_shape)
        skip = ['fc.weight', 'fc.bias']
        google_pretrained_state_dict = model_zoo.load_url(
        ...
        for key in state_dict.keys():
            if key in skip:
                continue
            state_dict[key] = google_pretrained_state_dict[key]
        model.load_state_dict(state_dict)
        return model

    return Inception3(num_classes=num_classes, input_shape=input_shape)
...
class Inception3(nn.Module):
    def __init__(self, num_classes, input_shape):
        ...
        self.Conv2d_1a_3x3 = BasicConv2d(in_channels, 32,
